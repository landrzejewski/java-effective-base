...
public final class BankService implements Bank {

    private final Supplier<AccountNumber> accountNumberSupplier;
    private final AccountRepository accountRepository;

    public BankService(final Supplier<AccountNumber> accountNumberSupplier, final AccountRepository accountRepository) {
